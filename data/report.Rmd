...
cat(sprintf(
  '<span style="color:%s; padding:3px; text-shadow: -1px -1px 0 black, 1px -1px 0 black, -1px 1px 0 black, 1px 1px 0 black;"><b>%s</b></span><br>',
...
cat(sprintf( '<span style="color:%s; padding:3px; text-shadow: -1px -1px 0 black, 1px -1px 0 black, -1px 1px 0 black, 1px 1px 0 black;"><b>%s</b></span><br>', finalCol, S_Objectives[fo]))
}
} else {
...
for (i in seq_along(keeper2)) {
  ...
  for (j in seq_along(keeper2[[i]]$Indicator)) {
    ...
    # END PLOT
      ...
      cat(sprintf("%s.\n\n", " "))
      cat(sprintf("%s.\n\n", keeper2[[i]]$Status[j]))
      if (!(keeper2[[i]]$Trend[j] == "There is no temporal dimension in this data.")) {
      cat(sprintf("%s.\n\n", keeper2[[i]]$Trend[j]))
      }
      cat(sprintf("%s.\n\n", " "))
