...
cat(sprintf(
  '<details>
     <summary style="
        ...
        border-radius: 4px;
        margin-bottom: 5px;">
        %s <span style="background-color:%s; color:white; padding:2px 6px; border-radius:4px;">%s</span>
     </summary>\n\n',
  pillar_ecol_df2$indicator[keep[j]],
  ...
  ifelse(is.na(pillar_ecol_df2$score[keep[j]]) | pillar_ecol_df2$score[keep[j]] == "NA", " ", pillar_ecol_df2$score[keep[j]])
))
