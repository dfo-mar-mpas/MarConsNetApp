...
if (length(com$project_id) != 0) {
  cat(paste0("<p>The below investment information is based on the following internal DFO projects that have had samples in ",
             state$mpas, " : ",
