...
indicator_targets <- list(
    ...
    name = ind_designtarget,
    {
      ...
      x <- process_indicator(data = cp,
                        ...
                        type = case_when(
                          ...
                          str_detect(description, regex("Modelled", ignore_case = TRUE)) ~ "model",
                          str_detect(description, regex("Classification system", ignore_case = TRUE)) ~ "model",

                          # ---- IN SITU ----
                          str_detect(description, regex("survey data", ignore_case = TRUE)) ~ "in situ",
                          str_detect(label, regex("Landings", ignore_case = TRUE)) ~ "in situ",

                          # ---- EXPERT OPINION ----
                          str_detect(description, regex("Formally declared", ignore_case = TRUE)) ~ "expert opinion",
  ...
  tar_target(name = ind_seabed_disruption_in_around_webmr_fishing,
             command = {
               ind_placeholder(ind_name="Seabed area in and surrounding WEBMR swept by bottom-tending commercial fishing gear", areas = MPAs[which(MPAs$NAME_E == "Western and Emerald Banks Marine Refuge"),], readiness = "Unknown",
  ...
  tar_target(name = ind_seabed_disruption_in_around_webmr_research,
             command = {
               ind_placeholder(ind_name="Seabed area in and surrounding WEBMR swept by bottom-tending commercial fishing gear for research and monitoring", areas = MPAs[which(MPAs$NAME_E == "Western and Emerald Banks Marine Refuge"),], readiness = "Unknown",
  ...
  tar_target(name = ind_cables,
             command = {
               ind_placeholder(ind_name="Number of cables by type", areas = MPAs[which(MPAs$NAME_E == "Western and Emerald Banks Marine Refuge"),], readiness = "Unknown",
  ...
  tar_target(name = ind_well_proximity,
             command = {
               ind_placeholder(ind_name="Number of wells in proximity to WEBMR", areas = MPAs[which(MPAs$NAME_E == "Western and Emerald Banks Marine Refuge"),], readiness = "Unknown",
...
"), theme="Ocean Structure and Movement")
  ...
  tar_target(name = ind_cpue,
             command = {
               ind_placeholder(ind_name="Commercial and recreational fishing catch per unit effort", areas = MPAs[which(MPAs$NAME_E == "Musquash Estuary Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain productivity of harvested species",
                                                           "Help maintain healthy populations of species of Aboriginal, commercial, and/or recreational importance",
                                                           "Distribute population component mortality in relation to component biomass",
  ...
  tar_target(name = ind_mpa_use_nbw,
             command = {
               ind_placeholder(ind_name="Use of the Gully by Northern Bottlenose Whales ", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),],readiness = "Unknown",
                               source = NA, objectives = c("Minimize harmful impacts from human activities on cetacean populations and their habitats",
                                                           "Protect unique, rare, or sensitive ecological features",
                                                           "Contribute to the recovery and conservation of depleted species",
  ...
  tar_target(name = ind_population_characteristics,
             command = {
               ind_placeholder(ind_name="Size, age, and sex structure of the Scotian Shelf population of Northern Bottlenose Whales", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Minimize harmful impacts from human activities on cetacean populations and their habitats",
                                                           "Contribute to the recovery and conservation of depleted species",
                                                           "Ensure the conservation and protection of threatened or endangered species",
  ...
  tar_target(name = ind_fresh_scars,
             command = {
               ind_placeholder(ind_name="% of individuals in the Scotian Shelf Northern Bottlenose population showing fresh scars", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Minimize harmful impacts from human activities on cetacean populations and their habitats",
                                                           "Control unintended incidental mortality for all species",
                                                           "Ensure the conservation and protection of threatened or endangered species",
                                                           "promote the recovery of at-risk whales and wolffish"), theme="Marine Mammals and other Top Predators")
  ...
  tar_target(name = ind_blubber_contaminants,
             command = {
               ind_placeholder(ind_name="Level of contaminants in the blubber of individuals in the Scotian Shelf population of Northern Bottlenose Whales", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
  ...
  tar_target(name = ind_trawl_vunerable,
             command = {
               ind_placeholder(ind_name="Relative abundances, size distributions and diversity of selected groundfish and trawl-vunerable invertebrates in Zone 3 of the MPA", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain productivity of harvested species",
                                                           "Manage the disturbance of benthic habitat that supports juvenile and adult haddock and other groundfish species",
                                                           "Help maintain healthy populations of species of Aboriginal, commercial, and/or recreational importance",
  ...
  tar_target(name = ind_longline_vunerable,
             command = {
               ind_placeholder(ind_name="Relative abundances, size distributions and diversity of selected longline-vunerable species in Zones 2 and 3 of the MPA", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain productivity of harvested species",
                                                           "Manage the disturbance of benthic habitat that supports juvenile and adult haddock and other groundfish species",
                                                           "Help maintain healthy populations of species of Aboriginal, commercial, and/or recreational importance",
                                                           "Conserve and protect marine areas of high biodiversity at the community, species, population and genetic levels within the MPA"), theme="Fish and Fishery Resources")
  ...
  tar_target(name = ind_trap_vunerable,
             command = {
               ind_placeholder(ind_name="Relative abundances, size distributions and diversity of selected trap-vunerable species in Zonea 1 and 2 of the MPA", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain productivity of harvested species",
                                                           "Manage the disturbance of benthic habitat that supports juvenile and adult haddock and other groundfish species",
                                                           "Help maintain healthy populations of species of Aboriginal, commercial, and/or recreational importance",
                                                           "Conserve and protect marine areas of high biodiversity at the community, species, population and genetic levels within the MPA"), theme="Fish and Fishery Resources")
  ...
  tar_target(name = ind_corals_removed,
             command = {
               ind_placeholder(ind_name="Quantities of corals removed from within the MPA by commercial fishing or research activity", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Protect cold-water corals",
                                                           "Protect cold-water corals and deep water frontier area",
                                                           "Protect corals, particularly significant concentrations of sea pens, from harm due to human activities (e.g., fishing, oil and gas exploratory drilling, submarine cable installation and anchoring) in the Laurentian Channel",
  ...
  tar_target(name = ind_target_org_removed_gully,
             command = {
               ind_placeholder(ind_name="Quantities of taget organisims removed from within the MPA and of bycatch organisms other than corals removed from the MPA by commercial fishing", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain productivity of harvested species",
                                                           "Manage human activities to minimize impacts on other commercial and non-commercial living resources",
                                                           "Control unintended incidental mortality for all species",
                                                           "Keep fishing and other forms of mortality moderate"), theme="Anthropogenic Pressure and Impacts")
  ...
  tar_target(name = ind_seabed_swept,
             command = {
               ind_placeholder(ind_name="Area of seabed swept by bottom-tending mobile research and monitoring gear in the MPA as a total and subdivided by seabed habitat type", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Minimize the disturbance of seafloor habitat and associated benthic communities caused by human activities",
                                                           "Manage the disturbance of benthic habitat that supports juvenile and adult haddock and other groundfish species",
                                                           "Conserve and protect all major benthic, demersal (i.e., close to the sea floor) and pelagic (i.e., in the water column) habitats within the MPA, along with their associated physical, chemical, geological and biological properties and processes",
                                                           "Habitat required for all species, particularly priority species, is maintained and protected"), theme="Anthropogenic Pressure and Impacts")
  ...
  tar_target(name = ind_seabed_occupied,
             command = {
               ind_placeholder(ind_name="Length of lines of, and seabed area occupied by, bottom-set fixed commercial fishing and research and monitoring gears within the MPA, as totals and subdivided by seabed habitat type", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Minimize the disturbance of seafloor habitat and associated benthic communities caused by human activities",
                                                           "Manage the disturbance of benthic habitat that supports juvenile and adult haddock and other groundfish species",
                                                           "Conserve and protect all major benthic, demersal (i.e., close to the sea floor) and pelagic (i.e., in the water column) habitats within the MPA, along with their associated physical, chemical, geological and biological properties and processes",
                                                           "Habitat required for all species, particularly priority species, is maintained and protected"), theme="Anthropogenic Pressure and Impacts")
  ...
  tar_target(name = ind_other_discharge,
             command = {
               ind_placeholder(ind_name="Number, quantities and type of other discharges from shipping within or in proximity to the MPA", areas = MPAs[which(MPAs$NAME_E == "Gully Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain and monitor the quality of water and sediments of the Gully; and",
                                                           "Control introduction and proliferation of disease/pathogens",
                                                           "Safeguard habitat, including the physical and chemical properties of the ecosystem, by maintaining water and sediment quality",
  ...
  tar_target(name = ind_mesozooplankton_community,
             command = {
               ind_placeholder(ind_name="Mesozooplankton community composition within the AOI and both upstream and downstream", areas = MPAs[which(MPAs$NAME_E == "St. Anns Bank Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Conserve and protect all major benthic, demersal (i.e., close to the sea floor) and pelagic (i.e., in the water column) habitats within the MPA, along with their associated physical, chemical, geological and biological properties and processes",
                                                           "Conserve and protect biological productivity across all trophic levels so that they are able to fulfill their ecological role in the ecosystems of the MPA",
                                                           "Help maintain ecosystem structure, functioning and resilience (including resilience to climate change)",
  ...
  tar_target(name = ind_compared_benthic_characteristics,
             command = {
               ind_placeholder(ind_name="Diversity and community composition of the benthos, abundance or biomass and size composition of selected benthic taxa and characteristics of surficial geology at comparable sampling stations outside the MPA", areas = MPAs[which(MPAs$NAME_E == "St. Anns Bank Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Conserve and protect all major benthic, demersal (i.e., close to the sea floor) and pelagic (i.e., in the water column) habitats within the MPA, along with their associated physical, chemical, geological and biological properties and processes",
                                                           "Minimize the disturbance of seafloor habitat and associated benthic communities caused by human activities",
                                                           "Habitat required for all species, particularly priority species, is maintained and protected",
                                                           "Maintain biodiversity of individual species, communities and populations within the different ecotypes"), theme="Benthic Environment")
  ...
  tar_target(name = ind_resource_species_abundance,
             command = {
               ind_placeholder(ind_name="Population-wide abundances and size distributions of those populations of resource species which utilize the MPA", areas = MPAs[which(MPAs$NAME_E == "St. Anns Bank Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain productivity of harvested species",
                                                           "Conserve and protect biological productivity across all trophic levels so that they are able to fulfill their ecological role in the ecosystems of the MPA",
                                                           "Maintain biodiversity of individual species, communities and populations within the different ecotypes",
  ...
  tar_target(name = ind_other_discharge_offshore,
             command = {
               ind_placeholder(ind_name="Number, quantities and type of discharges from vessels of all kinds or from offshore installations within, or in proximity to the MPA", areas = MPAs[which(MPAs$NAME_E == "St. Anns Bank Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain and monitor the quality of water and sediments of the Gully; and",
                                                          "Control introduction and proliferation of disease/pathogens",
                                                          "Safeguard habitat, including the physical and chemical properties of the ecosystem, by maintaining water and sediment quality",
                                                          "Minimize unintended introduction and transmission of invasive species"), theme='Anthropogenic Pressure and Impacts')
  ...
  tar_target(name = ind_other_discharge_coastal,
             command = {
               ind_placeholder(ind_name="Number, quantities and type of discharges from coastal sources within or in proximity to the MPA", areas = MPAs[which(MPAs$NAME_E == "St. Anns Bank Marine Protected Area"),], readiness = "Unknown",
                               source = NA, objectives = c("Maintain and monitor the quality of water and sediments of the Gully; and",
                                                           "Control introduction and proliferation of disease/pathogens",
                                                           "Safeguard habitat, including the physical and chemical properties of the ecosystem, by maintaining water and sediment quality",
                                                           "Minimize unintended introduction and transmission of invasive species"), theme='Anthropogenic Pressure and Impacts')
