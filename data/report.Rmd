...
for (i in seq_along(n_objectives)) {
  ...
  for (j in seq_along(keep)) {
    ...
    cat(sprintf("%s.\n\n", pillar_ecol_df$indicator_rationale[keep[j]]))
    ...
    # END PLOT
      ...
      cat(sprintf("%s.\n\n", " "))
      cat(sprintf("%s.\n\n", pillar_ecol_df$status_statement[keep[j]]))
      ...
      cat(sprintf("%s.\n\n", pillar_ecol_df$trend_statement[keep[j]]))
      }
      cat(sprintf("%s.\n\n", " "))
      cat(sprintf(
  "This indicator has a score of: %s.\n\nBased on the following scoring scheme: %s\n",
  pillar_ecol_df$score[keep[j]],
  pillar_ecol_df$scoring[keep[j]]
))

      cat(sprintf("%s.\n\n", " "))
      cat(sprintf(
        "Data was provided from %s.\n\n",
        ifelse(is.na(pillar_ecol_df$PPTID[keep[j]]), pillar_ecol_df$scoring[keep[j]], pillar_ecol_df$PPTID[keep[j]])
      ))
