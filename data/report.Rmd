...
```{r, echo=FALSE, comment=NA, results="asis"}
climateKeep <- which(binned_indicators$climate == "direct" & binned_indicators$mpa_name == params$mpas)
DF <- indicator_to_plot[climateKeep,]
cat(paste0(DF$indicators), collapse="\n\n")
```
